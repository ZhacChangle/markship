...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "mark-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "mark-upload-list-item", key: item.uid },

...
export var FormItem = function (props) {
    ...
    var rowClass = classNames('mark-row', {
        'mark-row-no-label': !label
    });
    // 注册
    useEffect(function () {
        // errors: initialValues[name] === false value=''
    ...
    var labelClass = classNames({
        'mark-form-item-required': isRequired
    });
    var itemClass = classNames('mark-form-item-control', {
        'mark-form-item-has-error': hasError
    });
    ...
    return (React.createElement("div", { className: rowClass },
        label &&
            React.createElement("div", { className: 'mark-form-item-label' },
                React.createElement("label", { title: label, className: labelClass }, label)),
        React.createElement("div", { className: 'mark-form-item' },
            React.createElement("div", { className: itemClass }, returnChildNode),
            hasError &&
                React.createElement("div", { className: 'mark-form-item-explain' },

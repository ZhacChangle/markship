...
export var Button = function (props) {
    var _a;
    var btnType = props.btnType, disabled = props.disabled, className = props.className, size = props.size, children = props.children, href = props.href, restProps = __rest(props, ["btnType", "disabled", "className", "size", "children", "href"]);

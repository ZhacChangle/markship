...
export const BasicForm: ComponentStory<typeof Form> = (args) => {
  return (
    <Form {...args} >
      ...
      <div className='mark-form-submit-area'>
...
export const RegForm: ComponentStory<typeof Form> = (args) => {
  const initialValues = {
    'agreement': false
  }
...
RegForm.storyName = 'RegForm'
export const FullForm: ComponentStory<typeof Form> = (args) => {
  ...
  return (
    <Form initialValues={{ username: 'mark', agreement: false }} {...args} ref={ref}>
